(function () {
    ...
    this.Int32Array || (this.Int32Array = Array, this.Float32Array = Array), t.Mat3 = function (t) {
        ...
        i = i || new t.Vec3;
        var n = this.elements, o = e.x, a = e.y, s = e.z;
        ...
        for (var i = new t.Mat3, n = 0; 3 > n; n++) for (var o = 0; 3 > o; o++) {
        ...
        var s, r;
        for (s = 0; 3 > s; s++) for (r = 0; 3 > r; r++) a[s + o * r] = this.elements[s + 3 * r];
        a[3] = e.x, a[7] = e.y, a[11] = e.z;
        var h, c, l = 3, u = l, p = 4;
        do {
            if (s = u - l, 0 === a[s + o * s]) for (r = s + 1; u > r; r++) if (0 !== a[s + o * r]) {
                h = p;
                do c = p - h, a[c + o * s] += a[c + o * r]; while (--h);
                break
            }
            if (0 !== a[s + o * s]) for (r = s + 1; u > r; r++) {
        ...
        var a, s;
        for (a = 0; 3 > a; a++) for (s = 0; 3 > s; s++) o[a + n * s] = this.elements[a + 3 * s];
        o[3] = 1, o[9] = 0, o[15] = 0, o[4] = 0, o[10] = 1, o[16] = 0, o[5] = 0, o[11] = 0, o[17] = 1;
        var r, h, c = 3, l = c, u = n;
        do {
            if (a = l - c, 0 === o[a + n * a]) for (s = a + 1; l > s; s++) if (0 !== o[a + n * s]) {
                r = u;
                do h = u - r, o[h + n * a] += o[h + n * s]; while (--r);
                break
            }
            if (0 !== o[a + n * a]) for (s = a + 1; l > s; s++) {
        ...
        var n = e.x, o = e.y, a = e.z, s = this.x, r = this.y, h = this.z;
        ...
        var t = this.x, e = this.y, i = this.z, n = Math.sqrt(t * t + e * e + i * i);
        if (n > 0) {
            var o = 1 / n;
        ...
        e = e || new t.Vec3;
        var i = this.x, n = this.y, o = this.z, a = Math.sqrt(i * i + n * n + o * o);
        ...
        var e = this.x, i = this.y, n = this.z, o = t.x, a = t.y, s = t.z;
        return Math.sqrt((o - e) * (o - e) + (a - i) * (a - i) + (s - n) * (s - n))
    }, t.Vec3.prototype.mult = function (e, i) {
        i = i || new t.Vec3;
        var n = this.x, o = this.y, a = this.z;
    ...
    t.Vec3.prototype.tangents = function (t, n) {
        ...
        var i = 2 * Math.acos(this.w), n = Math.sqrt(1 - this.w * this.w);
    ...
    var n = new t.Vec3, o = new t.Vec3, a = new t.Vec3;
    t.Quaternion.prototype.mult = function (e, i) {
        i = i || new t.Quaternion;
        var s = this.w, r = n, h = o, c = a;
        ...
        var i = this.x, n = this.y, o = this.z, a = this.w;
        ...
        if (i = i || new t.Vec3, 0 === this.w) i.x = e.x, i.y = e.y, i.z = e.z; else {
            var n = e.x, o = e.y, a = e.z, s = this.x, r = this.y, h = this.z, c = this.w, l = c * n + r * a - h * o,
                u = c * o + h * n - s * a, p = c * a + s * o - r * n, d = -s * n - r * o - h * a;
    ...
    t.Shape.prototype.calculateTransformedInertia = function (e, i, n) {
    ...
    }, t.Shape.types = {SPHERE: 1, PLANE: 2, BOX: 4, COMPOUND: 8, CONVEXPOLYHEDRON: 16}, t.Body = function (e) {
        ...
        if (this.allowSleep) {
            var e = this.sleepState, i = this.velocity.norm2(), n = Math.pow(this.sleepSpeedLimit, 2);
            0 === e && n > i ? (this.sleepState = 1, this.timeLastSleepy = t, this.dispatchEvent({type: "sleepy"})) : 1 === e && i > n ? this.wakeUp() : 1 === e && t - this.timeLastSleepy > this.sleepTimeLimit && (this.sleepState = 2, this.dispatchEvent({type: "sleep"}))
        }
    ...
    var l = new t.Vec3, u = new t.Vec3, p = new t.Vec3;
    ...
    t.SPHSystem.prototype.update = function () {
        ...
        var e = this.halfExtents.x, i = this.halfExtents.y, n = this.halfExtents.z, o = t.Vec3,
        ...
        if (i[0].set(n.x, 0, 0), i[1].set(0, n.y, 0), i[2].set(0, 0, n.z), i[3].set(-n.x, 0, 0), i[4].set(0, -n.y, 0), i[5].set(0, 0, -n.z), void 0 !== e) for (var o = 0; o !== i.length; o++) e.vmult(i[o], i[o]);
        return i
    ...
    new t.Vec3, t.Box.prototype.forEachWorldCorner = function (t, e, i) {
        for (var n = this.halfExtents, o = [[n.x, n.y, n.z], [-n.x, n.y, n.z], [-n.x, -n.y, n.z], [-n.x, -n.y, -n.z], [n.x, -n.y, -n.z], [n.x, n.y, -n.z], [-n.x, n.y, -n.z], [n.x, -n.y, n.z]], a = 0; o.length > a; a++) x.set(o[a][0], o[a][1], o[a][2]), e.vmult(x, x), t.vadd(x, x), i(x.x, x.y, x.z)
    ...
    var E = new t.Vec3, S = new t.Vec3, N = new t.Vec3, M = new t.Quaternion;
    t.Compound.prototype.calculateWorldAABB = function (t, e, i, n) {
        ...
        function a(t, e) {
            var i = r.faces[t], o = r.vertices[i[0]], a = r.vertices[i[1]], s = r.vertices[i[2]];
            return n(o, a, s, e)
        }

        function s(t) {
            var e = r.faces[t], i = r.faceNormals[t], n = r.vertices[e[0]], o = -i.dot(n);
            return o
        }
        ...
        for (var l = 0; this.faces.length > l; l++) {
            for (var u = 0; this.faces[l].length > u; u++) if (!this.vertices[this.faces[l][u]]) throw Error("Vertex " + this.faces[l][u] + " not found!");
            var p = new t.Vec3;
        ...
        for (var l = 0; this.faces.length > l; l++) for (var m = this.faces[l].length, w = m, u = 0; w > u; u++) {
            var b = (u + 1) % m, x = new t.Vec3;
            this.vertices[this.faces[l][u]].vsub(this.vertices[this.faces[l][b]], x), x.normalize();
            for (var g = !1, f = 0; this.uniqueEdges.length > f; f++) if (this.uniqueEdges[f].almostEquals(x) || this.uniqueEdges[f].almostEquals(x)) {
                g = !0;
                break
            }
        ...
        this.testSepAxis = function (t, e, i, n, a, s) {
            ...
            var l = r[0], u = r[1], p = h[0], d = h[1];
            if (d > l || u > p) return !1;
            var v = l - d, y = p - u, f = y > v ? v : y;
            return f
        };
        var z = new t.Vec3, E = new t.Vec3, S = new t.Vec3, N = new t.Vec3, M = new t.Vec3, P = new t.Vec3;
        this.findSeparatingAxis = function (t, e, i, n, o, a) {
            ...
            for (var d = 0, v = 0; r.uniqueEdges.length > v; v++) {
                ...
                for (var y = 0; t.uniqueEdges.length > y; y++) if (t.uniqueEdges[y].copy(M), o.vmult(M, M), N.cross(M, P), d++, !P.almostZero()) {
                    P.normalize();
        ...
        this.clipAgainstHull = function (e, i, n, o, a, s, r, h, c) {
            ...
            for (var v = [], y = n.faces[l], f = y.length, m = 0; f > m; m++) {
                var w = n.vertices[y[m]], b = new t.Vec3;
                w.copy(b), a.vmult(b, b), o.vadd(b, b), v.push(b)
            }
            l >= 0 && this.clipFaceAgainstHull(s, e, i, v, r, h, c)
        };
        var j = new t.Vec3, C = new t.Vec3, B = new t.Vec3, I = new t.Vec3, R = new t.Vec3, O = new t.Vec3,
            A = new t.Vec3, T = new t.Vec3;
        this.clipFaceAgainstHull = function (e, i, n, o, a, r, h) {
            ...
            var m = c.faces[d];
            m.connectedFaces = [];
            for (var w = 0; c.faces.length > w; w++) for (var b = 0; c.faces[w].length > b; b++) -1 !== m.indexOf(c.faces[w][b]) && w !== d && -1 === m.connectedFaces.indexOf(w) && m.connectedFaces.push(w);
            u.length;
            for (var x = m.length, g = 0; x > g; g++) {
                var V = c.vertices[m[g]], z = c.vertices[m[(g + 1) % x]];
            ...
            var a, s, r = e.length;
            if (2 > r) return i;
            var h = e[e.length - 1], c = e[0];
            a = n.dot(h) + o;
            for (var l = 0; r > l; l++) {
                if (c = e[l], s = n.dot(c) + o, 0 > a) if (0 > s) {
                    var u = new t.Vec3;
                    c.copy(u), i.push(u)
                } else {
                    var u = new t.Vec3;
        ...
        this.calculateLocalInertia = function (t, e) {
            r.computeAABB();
            var i = this.aabbmax.x - this.aabbmin.x, n = this.aabbmax.y - this.aabbmin.y,
            ...
            var t = this.vertices.length, e = this.aabbmin, i = this.aabbmax, n = this.vertices;
    ...
    t.ConvexPolyhedron.prototype.calculateWorldAABB = function (t, e, i, n) {
        ...
        if (t) for (var o = 0; i > o; o++) {
            var a = n[o];
            a.vadd(t, a)
        }
    };
    var q = new t.Vec3, j = new t.Vec3, C = new t.Vec3;
    t.ConvexPolyhedron.prototype.pointIsInside = function (t) {
        var e = this.vertices.length, i = this.vertices, n = this.faces, o = this.faceNormals, a = null,
            s = this.faces.length, r = q;
        this.getAveragePointLocal(r);
        for (var h = 0; s > h; h++) {
            this.faces[h].length;
            var e = o[h], c = i[n[h][0]], l = j;
            t.vsub(c, l);
            var u = e.dot(l), p = C;
            r.vsub(c, p);
            var d = e.dot(p);
        ...
        var s = new t.Vec3, r = new t.Vec3, h = new t.Vec3;
        new t.Vec3, new t.Vec3;
        var c = new t.Vec3, l = new t.Vec3, u = new t.Vec3;
            ...
            if (e instanceof t.ConvexPolyhedron) {
                ...
                for (var m, w, b = e.faces, x = e.vertices, g = e.faceNormals, V = 0; b.length > V; V++) {
                    ...
                    if (x[z[0]].copy(c), S.vmult(c, c), c.vadd(N, c), c.vsub(this.origin, c), S.vmult(E, l), m = this.direction.dot(l), !(a > Math.abs(m)) && (w = l.dot(c) / m, !(0 > w) && 0 > m)) {
                        ...
                        for (var M = 1; z.length - 1 > M; M++) if (x[z[M]].copy(r), x[z[M + 1]].copy(h), S.vmult(r, r), S.vmult(h, h), N.vadd(r, r), N.vadd(h, h), o(u, s, r, h)) {
                            v = {distance: this.origin.distanceTo(u), point: u.copy(), face: z, body: d}, y.push(v);
                            break
                        }
                    }
                }
    ...
    var I = new t.Vec3, R = new t.Vec3, O = (new t.Quaternion, new t.Vec3);
    t.Broadphase.prototype.doBoundingSphereBroadphase = function (e, i, n, o) {
        var a = t.Shape.types, s = a.SPHERE | a.BOX | a.COMPOUND | a.CONVEXPOLYHEDRON, r = a.PLANE;
        t.Body.STATIC | t.Body.KINEMATIC;
        var h = I, c = R, l = O, u = e.shape, p = i.shape;
        if (u && p) {
            var d = u.type, v = p.type;
            if (d & s && v & s) {
                ...
                var f = d === r ? e : i, m = d !== r ? e : i, w = m.shape, b = f.shape;
            ...
            var g = u ? i : e, V = u ? e : i, w = V.shape, z = w.type;
            if (z & s) {
                if (z === a.SPHERE) g.position.vsub(V.position, l), w.radius * w.radius >= l.norm2() && (n.push(g), o.push(V)); else if (z === a.CONVEXPOLYHEDRON || z === a.BOX || z === a.COMPOUND) {
        ...
        var a = e.shape, s = i.shape;
        if (e.aabbNeedsUpdate && e.computeAABB(), i.aabbNeedsUpdate && i.computeAABB(), a && s) e.aabbmax.x < i.aabbmin.x || e.aabbmax.y < i.aabbmin.y || e.aabbmax.z < i.aabbmin.z || e.aabbmin.x > i.aabbmax.x || e.aabbmin.y > i.aabbmax.y || e.aabbmin.z > i.aabbmax.z || (n.push(e), o.push(i)); else if (a || s) {
            var r = a ? i : e, h = a ? e : i;
    ...
    t.Broadphase.prototype.makePairsUnique = function (t, e) {
        ...
        for (var s = 0; s !== a; s++) {
            var r = n[s].id, h = o[s].id, c = h > r ? r + "," + h : h + "," + r;
            i[c] = s
        }
        for (var c in i) {
            var s = i[c];
        ...
        for (n = 0; n !== h; n++) for (o = 0; o !== n; o++) a = r[n], s = r[o], this.needBroadphaseCollision(a, s) && this.intersectionTest(a, s, e, i)
    ...
    var k = new t.Vec3, U = new t.Vec3;
    t.GridBroadphase.prototype.collisionPairs = function (e, i, n) {
        var o = e.numObjects(), a = e.bodies, s = this.aabbMax, r = this.aabbMin, h = this.nx, c = this.ny, l = this.nz,
            u = s.x, p = s.y, d = s.z, v = r.x, y = r.y, f = r.z, m = h / (u - v), w = c / (p - y), b = l / (d - f),
            x = (u - v) / h, g = (p - y) / c, V = (d - f) / l, z = t.Shape.types, E = z.SPHERE, S = z.PLANE;
        ...
        for (var q = Math.floor, P = 0; P !== o; P++) {
            ...
            switch (C.type) {
                case E:
                    for (var B = j.position.x, I = j.position.y, R = j.position.z, O = C.radius, A = q(m * (B - O - v)), T = q(w * (I - O - y)), F = q(b * (R - O - f)), W = q(m * (B + O - v)), L = q(w * (I + O - y)), D = q(b * (R + O - f)), H = A; H !== W + 1; H++) for (var Q = T; Q !== L + 1; Q++) for (var X = F; X !== D + 1; X++) {
                        var G = H, Y = Q, Z = X, _ = G * (c - 1) * (l - 1) + Y * (l - 1) + Z;
                        _ >= 0 && M > _ && N[_].push(j)
                    }
                    break;
                case S:
                    var K = k, J = U, $ = .25 * (x * x + g * g + V * V), te = C.worldNormal;
                    C.worldNormalNeedsUpdate && C.computeWorldNormal(j.quaternion);
                    for (var H = 0; H !== h; H++) for (var Q = 0; Q !== c; Q++) for (var X = 0; X !== l; X++) {
                        var G = H, Y = Q, Z = X;
        ...
        for (var P = 0; P !== M; P++) for (var ee = N[P], H = 0, ie = ee.length; H !== ie; H++) for (var j = ee[H], Q = 0; Q !== H; Q++) {
            var ne = ee[Q];
    ...
    t.GSSolver.prototype.solve = function (t, e) {
        var i, n, o, a, s, r, h = (this.d, this.k, 0), c = this.iterations, l = this.tolerance * this.tolerance,
            u = (this.a, this.b), p = this.equations, d = p.length, v = e.bodies, y = v.length, f = t, m = L, w = D,
            b = W;
        ...
        if (0 !== d) {
            for (var x = 0; x !== y; x++) {
                var u = v[x], V = u.vlambda, z = u.wlambda;
            ...
            for (var x = 0; x !== y; x++) {
                var u = v[x], S = u.velocity, N = u.angularVelocity;
    ...
    t.SplitSolver.prototype.solve = function (e, i) {
        ...
        function o(t, e) {
            var i = [];
            for (i.push(t), t.visited = !0, e(t); i.length;) for (var o, a = i.pop(); o = n(a.children);) o.visited = !0, e(o), i.push(o)
        }
        ...
        for (var v = 0; v !== c; v++) {
            var y = h[v], p = r.indexOf(y.bi), f = r.indexOf(y.bj), m = s[p], w = s[f];
        ...
        t.world = null;
        var e = this.numObjects() - 1, i = this.bodies;
        i.splice(t.index, 1);
    ...
    var Y = {type: "postStep"}, Z = {type: "collide", "with": null, contact: null}, _ = [], K = [], J = [], $ = [],
        te = new t.Vec3,
    ...
    t.World.prototype.step = function (e) {
        var i, n = this.contacts, o = J, a = $, s = this.numObjects(), r = this.bodies, h = this.solver,
            c = this.gravity, l = this.doProfiling, u = this.profile, p = t.Body.DYNAMIC, d = this._now,
            v = this.constraints, y = t.FrictionEquation, f = K, m = c.norm(), w = c.x, b = c.y, x = c.z, g = 0;
        for (l && (i = d()), void 0 === e && (e = this.last_dt || this.default_dt), g = 0; g !== s; g++) {
            var V = r[g];
            if (V.motionstate & p) {
                var z = V.force, E = V.mass;
        ...
        var P = n.length, q = this.frictionEquations.length;
        for (g = 0; g !== q; g++) f.push(this.frictionEquations[g]);
        this.frictionEquations.length = 0;
        for (var j = 0; j !== P; j++) {
            var C = n[j], V = C.bi, B = C.bj, g = r.indexOf(V), I = r.indexOf(B),
                R = this.getContactMaterial(V.material, B.material) || this.defaultContactMaterial, O = R.friction;
            R.restitution;
            var A = te;
            ...
            if (0 > T) {
                if (C.restitution = R.restitution, C.penetration = T, C.stiffness = R.contactEquationStiffness, C.regularizationTime = R.contactEquationRegularizationTime, h.addEquation(C), O > 0) {
                    var F = O * m, k = V.invMass + B.invMass;
                    k > 0 && (k = 1 / k);
                    var U = f, W = U.length ? U.pop() : new y(V, B, F * k), L = U.length ? U.pop() : new y(V, B, F * k);
        ...
        for (g = 0; g !== s; g++) {
            var V = r[g];
            if (V.motionstate & p) {
                var G = X(1 - V.linearDamping, e), ne = V.velocity;
                ne.mult(G, ne);
        ...
        l && (i = d());
        var se = ee, re = ie, he = this.stepnumber, ce = t.Body.DYNAMIC | t.Body.KINEMATIC,
            le = 0 === he % (this.quatNormalizeSkip + 1), ue = this.quatNormalizeFast, pe = .5 * e,
            de = t.Shape.types.PLANE, ve = t.Shape.types.CONVEXPOLYHEDRON;
        for (g = 0; g !== s; g++) {
            var ye = r[g], fe = ye.shape, me = ye.force, we = ye.tau;
            if (ye.motionstate & ce) {
                var be = ye.velocity, xe = ye.angularVelocity, ge = ye.position, Ve = ye.quaternion, ze = ye.invMass,
                    Ee = ye.invInertia;
        ...
        function s(t, i, n, o, a, s, r, h, c) {
            ...
            for (var u = i.radius, p = !1, d = q, v = j, y = C, f = null, w = 0, b = 0, x = 0, g = null, V = 0, B = l.length; V !== B && p === !1; V++) {
                ...
                if (R + u > O && O > 0) {
                    ...
                    var F = A.norm(), k = T.norm();
                    A.normalize(), T.normalize();
                    var U = z.dot(A), W = z.dot(T);
                    if (F > U && U > -F && k > W && W > -k) {
            ...
            for (var H = m.get(), Q = P, X = 0; 2 !== X && !p; X++) for (var G = 0; 2 !== G && !p; G++) for (var Y = 0; 2 !== Y && !p; Y++) if (H.set(0, 0, 0), X ? H.vadd(l[0], H) : H.vsub(l[0], H), G ? H.vadd(l[1], H) : H.vsub(l[1], H), Y ? H.vadd(l[2], H) : H.vsub(l[2], H), a.vadd(H, Q), Q.vsub(o, Q), u * u > Q.norm2()) {
                p = !0;
                var D = e(h, c);
                Q.copy(D.ri), D.ri.normalize(), D.ri.copy(D.ni), D.ri.mult(u, D.ri), H.copy(D.rj), t.push(D)
            }
            m.release(H), H = null;
            for (var Z = m.get(), _ = m.get(), D = m.get(), K = m.get(), L = m.get(), J = l.length, X = 0; X !== J && !p; X++) for (var G = 0; G !== J && !p; G++) if (X % 3 !== G % 3) {
        ...
        function c(e, i, n, o, a, s, r, h, c) {
            for (var l = L, u = D, p = 0, d = 0, v = n.childShapes.length; d !== v; d++) {
                var f = [], m = u.pop() || new t.Quaternion, w = l.pop() || new t.Vec3;
        ...
        function v(t, i, n, o, a, s, r, h, c) {
            var l = -1, u = ie, p = oe, d = null, v = 0, y = ee;
            if (o.copy(y), y.vsub(a, y), r.conjugate(te), te.vmult(y, y), n.pointIsInside(y)) {
                ...
                for (var f = 0, m = n.faces.length; f !== m; f++) {
                    var w = [n.worldVertices[n.faces[f][0]]], b = n.worldFaceNormals[f];
                    o.vsub(w[0], ne);
                    var x = -b.dot(ne);
        ...
        function y(e, a, f, m, w, b, x, g, V) {
            var z = !1, E = t.Shape.types, S = E.SPHERE, N = E.PLANE, M = E.BOX, P = E.COMPOUND, q = E.CONVEXPOLYHEDRON;
            if (a && f) {
                if (a.type > f.type) {
                    var j;
        ...
        var f = [], m = new t.Vec3Pool, w = new t.Vec3, b = new t.Vec3, x = new t.Vec3, g = new t.Vec3, V = new t.Vec3,
            z = new t.Vec3, E = new t.Vec3, S = new t.Vec3, N = new t.Vec3,
            M = [new t.Vec3, new t.Vec3, new t.Vec3, new t.Vec3, new t.Vec3, new t.Vec3], P = new t.Vec3,
            q = new t.Vec3, j = new t.Vec3, C = new t.Vec3, B = new t.Vec3, I = new t.Vec3, R = new t.Vec3,
            O = new t.Vec3, A = new t.Vec3, T = new t.Vec3, F = new t.Vec3, k = new t.Vec3, U = new t.Vec3,
            W = new t.Vec3;
        new t.Vec3, new t.Vec3;
        var L = [], D = [], H = new t.Vec3, Q = new t.Vec3, X = new t.Vec3, G = new t.Vec3, Y = new t.Vec3,
            Z = new t.Vec3, _ = new t.Vec3, K = new t.Vec3, J = new t.Vec3, $ = new t.Vec3, te = new t.Quaternion,
            ee = new t.Vec3;
        new t.Vec3;
        var ie = new t.Vec3, ne = new t.Vec3, oe = new t.Vec3;
        ...
        var e = this.regularizationTime, i = this.stiffness;
    ...
    var ne = new t.Vec3, oe = new t.Vec3, ae = new t.Vec3;
    t.ContactEquation.prototype.computeB = function (t) {
        var e = this.a, i = this.b, n = this.bi, o = this.bj, a = this.ri, s = this.rj, r = this.rixn, h = this.rjxn,
            c = ae, l = n.velocity, u = n.angularVelocity ? n.angularVelocity : c, p = n.force, d = n.tau ? n.tau : c,
            v = o.velocity, y = o.angularVelocity ? o.angularVelocity : c, f = o.force, m = o.tau ? o.tau : c,
            w = this.penetrationVec, b = n.invMass, x = o.invMass, g = this.invIi, V = this.invIj;
        ...
        var E = z.dot(w), S = ne, N = oe;
        g.vmult(d, S), V.vmult(m, N);
        var M = this.restitution + 1, P = M * v.dot(z) - M * l.dot(z) + y.dot(h) - u.dot(r),
            q = f.dot(z) * x - p.dot(z) * b + h.dot(N) - r.dot(S), j = -E * e - P * i - t * q;
        return j
    }, new t.Vec3, new t.Vec3, t.ContactEquation.prototype.computeC = function () {
        var t = this.bi, e = this.bj, i = this.rixn, n = this.rjxn, o = t.invMass, a = e.invMass, s = o + a + this.eps,
            r = this.invIi, h = this.invIj;
    ...
    t.ContactEquation.prototype.computeGWlambda = function () {
        var t = this.bi, e = this.bj, i = se, n = 0;
    ...
    var re = new t.Vec3, he = new t.Vec3;
    t.ContactEquation.prototype.addToWlambda = function (t) {
        var e = this.bi, i = this.bj, n = (this.rixn, this.rjxn, e.invMass), o = i.invMass, a = this.ni, s = re, r = he;
    ...
    var ce = new t.Vec3, le = new t.Vec3, ue = new t.Vec3;
    t.FrictionEquation.prototype.computeB = function (t) {
        var e = this.a, i = this.b, n = this.bi, o = this.bj, a = this.ri, s = this.rj, r = this.rixt, h = this.rjxt,
            c = this.wixri, l = this.wjxrj, u = ue, p = n.velocity, d = n.angularVelocity ? n.angularVelocity : u,
            v = n.force, y = n.tau ? n.tau : u, f = o.velocity, m = o.angularVelocity ? o.angularVelocity : u,
            w = o.force, b = o.tau ? o.tau : u, x = (this.relVel, this.relForce, n.invMass), g = o.invMass,
            V = this.invIi, z = this.invIj, E = this.t, S = ce, N = le;
        ...
        var M = 0, P = f.dot(E) - p.dot(E) + l.dot(E) - c.dot(E), q = w.dot(E) * g - v.dot(E) * x + h.dot(N) - r.dot(S),
            j = -M * e - P * i - t * q;
        return j
    }, t.FrictionEquation.prototype.computeC = function () {
        var t = this.bi, e = this.bj, i = this.rixt, n = this.rjxt, o = t.invMass, a = e.invMass, s = o + a + this.eps,
            r = this.invIi, h = this.invIj;
    ...
    t.FrictionEquation.prototype.computeGWlambda = function () {
        var t = this.bi, e = this.bj, i = 0, n = pe;
    ...
    t.FrictionEquation.prototype.addToWlambda = function (t) {
        var e = this.bi, i = this.bj, n = (this.rixt, this.rjxt, e.invMass), o = i.invMass, a = this.t, s = de,
            r = e.wlambda, h = i.wlambda;
        ...
        var i = this.a, n = this.b, o = this.bi, a = this.bj, s = this.ni, r = this.nj, h = this.nixnj, c = this.njxni;
        o.velocity;
        ...
        var p = this.invIi, d = this.invIj;
        o.invInertia ? p.setTrace(o.invInertia) : p.identity(), a.invInertia ? d.setTrace(a.invInertia) : d.identity(), s.cross(r, h), r.cross(s, c);
        var v = -s.dot(r), y = c.dot(l) + h.dot(u), f = 0, m = -v * i - y * n - e * f;
        return m
    }, t.RotationalEquation.prototype.computeC = function () {
        var t = this.bi, e = this.bj, i = this.nixnj, n = this.njxni;
        t.invMass, e.invMass;
        var o = this.eps, a = this.invIi, s = this.invIj;
    ...
    t.RotationalEquation.prototype.computeGWlambda = function () {
        ...
        var e = this.bi, i = this.bj, n = this.nixnj;
        ...
        var a = this.equations = [new t.ContactEquation(e, i)], s = a[0];
    ...
    t.RotationalMotorEquation.prototype.computeGWlambda = function () {
        var t = this.bi, e = this.bj, i = this.axisA, n = this.axisB, o = 0;
        ...
        var e = this.bi, i = this.bj, n = this.axisA, o = this.axisB;
        ...
        var l, u = this.getRotationalEquation1(), p = this.getRotationalEquation2(),
            d = this.getPointToPointEquation1(), v = this.getPointToPointEquation2(),
            y = this.getPointToPointEquation3();
        v.minForce = y.minForce = d.minForce = -r, v.maxForce = y.maxForce = d.maxForce = r;
        var f = i.unit(), m = a.unit(), w = new t.Vec3, b = new t.Vec3, x = new t.Vec3;
